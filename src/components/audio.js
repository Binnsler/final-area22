      ...
      <div>
        ...
        <div>
          ...
          <div className="col-3-4">
            ...
            <p className="paragraph pad-20">This stage happens before you start to record your music. This is where the lyrics, chords, melody and arrangement are fleshed out and finalized. Basic instrumentation is used to get an organic feel of your song. Song charts can be created as a guide for the musicians to use while recording.</p>
