    ...
    return(
      <div>
        ...
        <div className="col-3-4">
          <p className="paragraph pad-20">We believe that all individuals possess great creative potential in which some have not fully realized due to imposed limitations or fear. Through our endeavors, we strive to inspire others to seek out the creativity that exists within them.</p>
